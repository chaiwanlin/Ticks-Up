...
# print(bull_credit_spread("aapl", 30, 150, 160, 30))
# print(bull_debit_spread("aapl", 30, 140, 150, 80))
# print(bear_credit_spread("aapl", 30, 130, 120, 80))
# print(bear_credit_spread("aapl", 30, 130, 120, 30))
# print(collar("aapl", 30, 120, 130, 150, 20))
# print(iron_condor("aapl", 30, 140, 150, 10))
# print(iron_condor("amc", 30, 30, 60, 100))
# print(bull_credit_spread("aapl", 30, 150, 160, 30))